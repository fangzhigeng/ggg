...
通过IDE运行[StartupApplication](/devops-provider/src/main/java/com/deepexi/StartupApplication.java)
...
```bash
$ mvn clean package
$ java -jar ./devops-provider/target/devops-provider-{version}.jar
```
